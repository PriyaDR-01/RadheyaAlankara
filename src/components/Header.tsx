        ...
        <div className="flex items-center justify-between h-20">
          <Link href="/" data-testid="link-home">
            <span className="flex items-center gap-3 hover-elevate active-elevate-2 rounded-md px-3 py-2 -ml-3 cursor-pointer">
              ...
              />
              <h1 className="font-serif text-xl sm:text-2xl md:text-2xl lg:text-3xl font-light tracking-wide text-gold-600">Radheya Alankara</h1>
            </span>
          </Link>
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="left" className="p-0 w-64">
                <nav className="flex flex-col gap-2 p-6">
                  <Link href="/">
                    <span 
                      className="flex items-center gap-2 font-serif text-lg sm:text-xl mb-4"
